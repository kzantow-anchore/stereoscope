...
// ExtractScheme parses a string with any colon-delimited prefix and validates it against the set
...
func ExtractScheme[T comparable](schemeTags tagged.Values[T], userInput string) (scheme, newInput string) {
